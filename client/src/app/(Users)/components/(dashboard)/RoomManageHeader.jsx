...
export default function RoomManageHeader() {
  return (
    <>
      <div className="flex justify-evenly gap-20 items-center h-20 border-b border-b-gray-400 sticky top-0 px-[60px] py-4 bg-utility-white font-sans font-semibold text-xl text-gray-900">
