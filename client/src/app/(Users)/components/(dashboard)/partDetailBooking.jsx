  ...
  return (
    <section>
      <div className="flex justify-start items-center left-[40px] bg-white w-full h-[80px] mb-4">
        ...
        {/* Full Name */}
        <h1 className="text-2xl mx-5 font-semibold">
        ...
        <div className="flex flex-col w-full h-full  justify-center items-center ">
          {loading ? (
            ...
            <div className="flex flex-col items-center bg-gray-100 w-[1080px] mt-[40px] mb-[61px] mx-[60px] h-[1388px] rounded-lg shadow-lg">
              ...
              <div className="w-[880px] h-[30px ] ite  mb-[40px] text-[20px] font-sans text-[#000]">
                <p>{detailData.customer_name} </p>
              </div>
              <div className="w-[880px] h-[30px ]  text-[#9AA1B9] text-[20px] font-sans font-semibold">
                Guest(s)
              </div>
              <div className="w-[880px] h-[30px ]  mb-[40px] text-[20px] font-sans text-[#000]">
                {detailData.guests}
              </div>
              <div className="w-[880px] h-[30px ]  text-[#9AA1B9] text-[20px] font-sans font-semibold">
                Room Type
              ...
              <div className="flex flex-col  justify-center items-center w-[920px] h-[278px] rounded-md bg-gray-300 mb-[40px]  ">
                <div className="flex flex-col items-center  justify-center h-[192px] w-[872px]">
                  <div className="flex items-end justify-end w-[872px] h-[40px] mb-[16px]">
                    <div className="flex w-[300px] h-[24px]  mr-[16px]">
                      <p className="mx-[2px]">Payment</p>{" "}
                      <p className="mx-[2px]">{detailData.payment_status}</p>
                      <p className="mx-[2px]">via</p>
                    </div>
                    <div className="flex w-[160px] h-[24px] ">
                      <div className="px-[2px] font-semibold">
                        {detailData.payment_method}{" "}
                      </div>
                      <div className="pl-[8px]">
                        {detailData.payment_method === "creditcard"
                          ? formatCreditCard(detailData.card_number)
                          : ""}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex  justify-between items-center text-[16px]  w-[872px] h-[48px]">
                    <div className="">{detailData.special_request}</div>
                    <div className=""></div>
                  </div>
                  <div className="flex  justify-between items-center text-[16px]  w-[872px] h-[48px]">
                    <div className="">{detailData.promotion}</div>
                    <div className=""></div>
                  </div>

                  <div className="flex justify-between border-t border-gray-300  w-[872px] h-[54px] mt-[24px]">
              ...
              <div className="flex flex-col justify-center items-center w-[920px] h-[88px] bg-gray-500 mb-[60px] ">
                <div className="w-[872px] h-[24px] mt-[16px] mb-[8px]">
                  Additional Request
                </div>
                <div className="w-[872px] h-[24px]">
