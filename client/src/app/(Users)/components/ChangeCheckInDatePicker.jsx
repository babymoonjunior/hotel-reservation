...
export function ChangeCheckInDatePicker({
  date,
  onDateChange,
  originalCheckIn,
  originalCheckOut,
  ...
  const defaultCheckIn = new Date(originalCheckIn); // แปลงเป็น object Date
  const [selectedDate, setSelectedDate] = useState(defaultCheckIn);
